...
public  class Vector3D {
    ...
    /**
     * Vector of plane frame (in plane)
     */
    private Vector3D u;
    
    /**
     *  Vector of the plane frame (in plane)
     */
    private Vector3D v;
    ...
    /**
     *  Simple Constructor : Vector3D
     *  build a vector from coordinates
     * @param x 
     * @param y
     * @param z
     * @see #getX()
    ...
    public static double angle(Vector3D v1, Vector3D v2) throws MathArithmeticException {
        ...
        double dot = v1.dotProduct((Vector<Euclidean3D>) v2);
    ...
    public static double dotProduct(Vector3D v1, Vector3D v2) {
        return v1.dotProduct((Vector<Euclidean3D>) v2);
    }
    ...
    public static Vector3D crossProduct(final Vector3D v1, final Vector3D v2) {
        return v1.crossProduct((Vector<Euclidean3D>) v2);
    }
    ...
    public static double distance1(Vector3D v1, Vector3D v2) {
        return v1.distance1((Vector<Euclidean3D>) v2);
    }
     ...
     */
    public static double distance(Vector<Euclidean3D> v1, Vector<Euclidean3D>v2) {
    ...
    public static double distanceInf(Vector3D v1, Vector3D v2) {
        return v1.distanceInf((Vector<Euclidean3D>) v2);
    }
    ...
    public static double distanceSq(Vector3D v1, Vector3D v2) {
        return v1.distanceSq((Vector<Euclidean3D>) v2);
    }

    /**
     *  Build a plane normal to a given direction and containing the origin.
     * @param normal normal direction to the plane
     * @param MathArithmeticException if the normal norm is too small
     */
