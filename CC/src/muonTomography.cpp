                ...
                int TDCoff)
{
    ...
    makeHodoscope(choice, NewConf, newTomoScope, NumDetN, NumChanN, geo, enU, lenU, s1, s2, s3, s4, segN, delSegN,
                  stripsN, delSN, detU, detD, delH0, delH1, oL, oW, oH, DobjDet, nTDC, nATDC, nScintU, nScintD, scintSN,
                  scintNumN, totC, detC0, stripL, stripW, stripH, modu0, TDCoff);
    ...
    scintMean = 0;
    for(int ii = 0; ii < totData; ii++) {
        for(int scI = 0; scI < scintNumN; scI++) {
